...
echo encrypt...
pwd
java -cp ../server-$APP_NAME/target/server-1.0.jar server.FileCipher ../server_credentials/conf/$APP_NAME/key target/$APP_NAME-1.0.0.jar code ../server-$APP_NAME/target/$APP_NAME-encrypted.jar
